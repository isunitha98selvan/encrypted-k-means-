...
def menu():
    ...
    button1=tkinter.Button(root1,text="1.ENTER PATIENT DETAILS",command=PAT,bg='light blue',fg='black')
    m.place(x=75,y=5)
...
def PAT():
    ...
    sex=tkinter.Label(rootp,text="HEART RATE")
    pat_sex=tkinter.Entry(rootp)
    dob=tkinter.Label(rootp, text="CHOLESTROL LEVEL")
    pat_dob=tkinter.Entry(rootp)
    bg=tkinter.Label(rootp, text="AGE")
